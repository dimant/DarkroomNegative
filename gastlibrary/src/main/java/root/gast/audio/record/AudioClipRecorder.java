...
public class AudioClipRecorder
{
    ...
    private IAudioClipListener clipListener;
    ...
    public AudioClipRecorder(IAudioClipListener clipListener)
    {
    ...
    public AudioClipRecorder(IAudioClipListener clipListener, AsyncTask task)
    {
        this(clipListener);
        this.task = task;
    }
